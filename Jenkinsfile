def registry = 'https://trialqrbazk.jfrog.io/artifactory'
def imageName = 'trialqrbazk.jfrog.io/taxiapp-docker-local/taxiapp'
def version   = '1.0.1'
pipeline {
    agent {
        node {
        ...
        stage('SonarQube Analysis') {
            steps {
                script {
                    ...
                    -Dsonar.projectKey=taxi-app001_taxi-app \
